...
def content_tab1():
    st.header("半神的試煉")
    st.image("/home/tzuyang2024/桌面/DND 照片/封面照.jpeg", use_container_width=True)
    ...
    expander.image("/home/tzuyang2024/桌面/DND 照片/希拉護符.jpeg", caption="孔雀翎墜飾（Peacock Plume Pendant）", use_container_width=True)
    expander.write(
        "以白銀精雕成孔雀羽毛的形狀，"
    ...
    expander.image("/home/tzuyang2024/桌面/DND 照片/阿波羅護符.jpeg", caption="黃金豎琴別針（Golden Lyre Brooch）", use_container_width=True)
    expander.write(
    ...
    expander.image("/home/tzuyang2024/桌面/DND 照片/阿提密斯護符.jpeg", caption="銀月弓墜（Silver Crescent Bow）", use_container_width=True)
    expander.write(
    ...
    expander.image("/home/tzuyang2024/桌面/DND 照片/荷米斯護符.jpeg", caption="飛翼足環（Winged Anklet）", use_container_width=True)
    expander.write(
    ...
    expander.image("/home/tzuyang2024/桌面/DND 照片/希拉祭壇.jpeg", caption="希拉祭壇", use_container_width=True)

    expander.write(
        "阿波羅祭壇以金色石英堆砌而成，四邊雕飾太陽放射線與月桂枝。中央豎立一具無弦琴，琴身光滑，反射上方光柱。牆面刻有詩文與箭矢圖騰，整體充滿秩序與光明的氛圍。"
    )
    expander.image("/home/tzuyang2024/桌面/DND 照片/阿波羅祭壇.jpeg", caption="阿波羅祭壇", use_container_width=True)

    expander.write(
        "阿提密斯祭壇以蒼灰石搭建，邊緣飾有野鹿奔馳與彎弓圖樣。上方懸掛一圈乾燥銀葉編織的花冠。地面布有繁星與林葉樣式的淺刻紋，周遭氣溫偏冷，空氣中有乾淨土壤與林木的氣息。"
    )
    expander.image("/home/tzuyang2024/桌面/DND 照片/阿提密斯祭壇.jpeg", caption="阿提密斯祭壇", use_container_width=True)

    expander.write(
        "荷米斯祭壇採用磨光青銅與銀飾混構，表面鑲有飛翼涼鞋、雙蛇杖的徽記。兩側懸掛銅鈴與收納袋。地面紋飾呈現流動與曲線形，整體結構不對稱但動感十足。"
    )
    expander.image("/home/tzuyang2024/桌面/DND 照片/荷米斯祭壇.jpeg", caption="荷米斯祭壇", use_container_width=True)



def content_tab2():
    st.header("雅典城")
    st.image("/home/tzuyang2024/桌面/DND 照片/雅典城.jpeg", use_container_width=True)
    ...
    expander.image("/home/tzuyang2024/桌面/DND 照片/執政官辦公室.jpeg", caption="執政官辦公室", use_container_width=True)
    ...
    expander.image("/home/tzuyang2024/桌面/DND 照片/梭倫.jpeg", caption="執政官梭倫", use_container_width=True)
    ...
    expander.image("/home/tzuyang2024/桌面/DND 照片/帕拉斯雜貨店.jpeg", caption="帕拉斯雜貨店", use_container_width=True)
    expander.subheader("帕拉斯")
    expander.write("坐在櫃檯後的中年婦人身著樸實但裁剪得體的麻布長裙，額上隱隱可見的細紋，卻難掩那雙深邃、明澈且洞悉一切的眼眸。")
    expander.image("/home/tzuyang2024/桌面/DND 照片/帕拉斯.jpeg", caption="帕拉斯", use_container_width=True)
    ...
    expander.image("/home/tzuyang2024/桌面/DND 照片/鐵匠鋪.jpeg", caption="赫菲斯托斯鐵匠鋪", use_container_width=True)
    ...
    expander.image("/home/tzuyang2024/桌面/DND 照片/卡力克斯.jpeg", caption="卡力克斯", use_container_width=True)
    ...
    expander.image("/home/tzuyang2024/桌面/DND 照片/狄蜜特麵包店.jpeg", caption="狄蜜特麵包店", use_container_width=True)
    ...
    expander.image("/home/tzuyang2024/桌面/DND 照片/瑪爾西婭.jpeg", caption="瑪爾西婭", use_container_width=True)
    ...
    expander.image("/home/tzuyang2024/桌面/DND 照片/荷米斯馬場.jpeg", caption="荷米斯馬場", use_container_width=True)
    ...
    expander.image("/home/tzuyang2024/桌面/DND 照片/尼克昂.jpeg", caption="尼克昂", use_container_width=True)
...
def content_tab3():
    ...
    st.image("/home/tzuyang2024/桌面/DND 照片/涅墨亞小鎮.jpeg", caption="涅墨亞小鎮", use_container_width=True)
    ...
    st.image("/home/tzuyang2024/桌面/DND 照片/里昂.jpeg", caption="里昂", use_container_width=True)
    ...
    st.image("/home/tzuyang2024/桌面/DND 照片/法蘭克.jpeg", caption="法蘭克", use_container_width=True)
    ...
    st.image("/home/tzuyang2024/桌面/DND 照片/涅墨亞獅子.png", caption="涅墨亞獅子", use_container_width=True)
...
def content_tab4():
    ...
    st.image("/home/tzuyang2024/桌面/DND 照片/沼澤.jpeg", caption="沼澤", use_container_width=True)
    ...
    st.image("/home/tzuyang2024/桌面/DND 照片/羊男地下洞窟.jpeg", caption="羊男地下洞窟", use_container_width=True)

    st.subheader("羊男潘波斯")
    st.write("當冒險者進入這片幽閉的空間時，一道低沉的嘆息聲從角落傳來。那裡蜷縮著一名羊男，他的身軀消瘦，雙腿像山羊般覆滿毛皮，頭上長著一對捲曲的犄角，雙眼暗淡無光，似乎早已接受自己的命運。")
    st.image("/home/tzuyang2024/桌面/DND 照片/羊男潘波斯.jpeg", caption="羊男潘波斯", use_container_width=True)
    ...
    st.image("/home/tzuyang2024/桌面/DND 照片/九頭蛇海德拉.png", caption="九頭蛇海德拉", use_container_width=True)
...
def content_tab5():
    ...
    st.image("/home/tzuyang2024/桌面/DND 照片/克列尼亞草原.jpeg", caption="克列尼亞草原", use_container_width=True)
    ...
    st.image("/home/tzuyang2024/桌面/DND 照片/黛安娜營區.jpeg", caption="獵人黛安娜營區", use_container_width=True)
    ...
    st.image("/home/tzuyang2024/桌面/DND 照片/月光獵人黛安娜.jpeg", caption="月光獵人黛安娜", use_container_width=True)

    st.subheader("克列尼亞牝鹿")
    st.write("這頭牝鹿的雙眼如琥珀般透亮，充滿靈性，蹄子輕盈無聲，能以不可思議的速度穿梭於森林之間。傳說牠可奔馳如疾風，甚至能踏浪過河，沒有人能輕易追上它。牠不懼生人，但也絕不輕易被捕捉。")
    st.image("/home/tzuyang2024/桌面/DND 照片/克列尼亞牝鹿.png", caption="克列尼亞牝鹿", use_container_width=True)
...
def content_tab6():
    ...
    st.image("/home/tzuyang2024/桌面/DND 照片/厄律曼托斯山.jpeg", caption="厄律曼托斯山脈", use_container_width=True)

    st.subheader("厄律曼托斯山野豬")
    st.write("體型如牛，渾身覆蓋深棕與鐵灰交錯的粗硬毛髮，雙目泛紅如火，獠牙彎曲粗長。蹄聲沉重，奔行如雷，每次呼吸皆吐出白霧與低鳴，身上隱有古老符紋般的傷痕，散發殘暴與原始怒意。")
    st.image("/home/tzuyang2024/桌面/DND 照片/厄律曼托斯山野豬.jpeg", caption="厄律曼托斯山野豬", use_container_width=True)

    st.subheader("盜賊傭兵團")
    st.write("多人組成，身著舊戰甲與毛皮，皮膚曬黑斑駁，武器混雜但上手純熟，臉上或帶戰紋，或蒙布遮面。他們行事粗暴，彼此少語但動作協調，眼神警惕，行蹤如狼群般悄然逼近。")
    st.image("/home/tzuyang2024/桌面/DND 照片/盜賊傭兵團.jpeg", caption="盜賊傭兵團", use_container_width=True)
...
def content_tab7():
    ...
    st.image("/home/tzuyang2024/桌面/DND 照片/沉音花園.jpeg", caption="沉音花園", use_container_width=True)
    ...
    st.image("/home/tzuyang2024/桌面/DND 照片/罪潮裂口.jpeg", caption="逆律殿堂", use_container_width=True)
    ...
    st.image("/home/tzuyang2024/桌面/DND 照片/王宮侍女薇拉.jpeg", caption="王宮侍女薇拉", use_container_width=True)

    st.subheader("奧格阿斯王")
    st.write("蒼老而枯槁的男子，披著殘破的王袍，指節如枯枝，雙眼混濁卻時而閃現神智的火光。他滿身塵垢與牛糞味，頭戴傾斜的破冠，神智游移不定，語句跳躍反覆。肩背微駝，步履不穩，時常爆發出異常狂熱，聲如雷吼，氣如火發，彷彿仍是王座上的掌權者。")
    st.image("/home/tzuyang2024/桌面/DND 照片/奧格阿斯王.jpeg", caption="奧格阿斯王", use_container_width=True)
...
def content_tab8():
    ...
    st.image("/home/tzuyang2024/桌面/DND 照片/斯廷法利斯湖.jpeg", caption="斯廷法利斯湖", use_container_width=True)

    st.subheader("湖中遺跡")
    st.write("半沉於湖中的一座古老神殿。現在堆滿了鋒利金屬羽毛與半融化的盔甲。")
    st.image("/home/tzuyang2024/桌面/DND 照片/湖中遺跡.jpeg", caption="湖中遺跡", use_container_width=True)
    ...
    st.image("/home/tzuyang2024/桌面/DND 照片/斯廷法利斯湖女戰士.jpeg", caption="幽靈女戰士梅麗瑟", use_container_width=True)
...
def content_tab9():
    ...
    st.image("/home/tzuyang2024/桌面/DND 照片/迷宮入口.jpeg", caption="迷宮入口", use_container_width=True)
    ...
    st.image("/home/tzuyang2024/桌面/DND 照片/神殿.jpeg", caption="祭壇", use_container_width=True)
    ...
    expander.image("/home/tzuyang2024/桌面/DND 照片/帕西淮遊蕩處.jpeg", caption="帕西淮遊蕩處", use_container_width=True)
    ...
    expander.image("/home/tzuyang2024/桌面/DND 照片/帕西淮.jpeg", caption="帕西淮", use_container_width=True)
    ...
    expander.image("/home/tzuyang2024/桌面/DND 照片/代達羅斯工作室.jpeg", caption="代達羅斯工作室", use_container_width=True)
    ...
    expander.image("/home/tzuyang2024/桌面/DND 照片/代達羅斯.jpeg", caption="代達羅斯", use_container_width=True)
    ...
    st.image("/home/tzuyang2024/桌面/DND 照片/房間 A.jpeg", caption="房間 A", use_container_width=True)
    ...
    st.image("/home/tzuyang2024/桌面/DND 照片/房間 B.jpeg", caption="房間 B", use_container_width=True)
    ...
    st.image("/home/tzuyang2024/桌面/DND 照片/克里特公牛.jpeg", caption="???", use_container_width=True)
    ...
    st.image("/home/tzuyang2024/桌面/DND 照片/彌諾陶.jpeg", caption="???", use_container_width=True)
...
def content_tab10():
    ...
    st.image("/home/tzuyang2024/桌面/DND 照片2/空蕩城邦.jpeg", caption="空蕩城邦", use_container_width=True)
    ...
    expander.image("/home/tzuyang2024/桌面/DND 照片2/宮殿大廳.jpeg", caption="宮殿大廳", use_container_width=True)
    expander.subheader("皇家馬廄")
    expander.write("馬廄四周被古老的石牆包圍，這裡的空間大而寬敞，廄內放著許多精緻的馬具與武器，木地板上鋪著厚厚的乾草。")
    expander.image("/home/tzuyang2024/桌面/DND 照片2/皇家馬廄.jpeg", caption="皇家馬廄", use_container_width=True)
    expander.subheader("王宮文件室")
    expander.write("這間文件室收藏著王國所有珍貴的卷軸和手稿。高高的書架上擺滿了知識與智慧的結晶，空氣中彌漫著老舊書本的味道。此地不僅是知識的寶庫，也是王國政府謀劃與計劃的重要場所。")
    expander.image("/home/tzuyang2024/桌面/DND 照片2/文件室.jpeg", caption="王宮文件室", use_container_width=True)
    ...
    expander.image("/home/tzuyang2024/桌面/DND 照片2/王宮地下室.jpeg", caption="王宮地下室", use_container_width=True)
    ...
    expander.image("/home/tzuyang2024/桌面/DND 照片2/秘密花園.jpeg", caption="秘密花園", use_container_width=True)
    ...
    expander.image("/home/tzuyang2024/桌面/DND 照片2/宮殿露台.jpeg", caption="宮殿露台", use_container_width=True)
    ...
    st.image("/home/tzuyang2024/桌面/DND 照片2/煙霧林地.jpeg", caption="煙霧林地", use_container_width=True)
    ...
    st.write("-- 金黃（Xanthos）")
    st.image("/home/tzuyang2024/桌面/DND 照片2/牝馬.jpeg", caption="牝馬", use_container_width=True)
...
def content_tab11():
    ...
    expander.image("/home/tzuyang2024/桌面/DND 照片2/亞馬遜王國.jpeg", caption="亞馬遜王國", use_container_width=True)
    ...
    expander.image("/home/tzuyang2024/桌面/DND 照片2/王國監獄.jpeg", caption="王國監獄", use_container_width=True)
    ...
    expander.image("/home/tzuyang2024/桌面/DND 照片2/希波呂忒.jpeg", caption="亞馬遜女王希波呂忒", use_container_width=True)
    expander.subheader("女王副官伊法恩")
    expander.write("個性激進，極不信任外來者，總認為冒險者圖謀不軌。主張直接逐出或審判入侵者。她是玩家在部族內最可能遇到的阻礙。")
    expander.image("/home/tzuyang2024/桌面/DND 照片2/伊法恩.jpeg", caption="女王副官伊法恩", use_container_width=True)
    ...
    expander.image("/home/tzuyang2024/桌面/DND 照片2/聖火工坊.jpeg", caption="聖火工坊", use_container_width=True)
    ...
    expander.image("/home/tzuyang2024/桌面/DND 照片2/塞瑞薇.jpeg", caption="塞瑞薇 – 年輕的亞馬遜學者與製帶工匠", use_container_width=True)
...
def content_tab12():
    ...
    expander.image("/home/tzuyang2024/桌面/DND 照片2/格律翁堡壘.jpeg", caption="格律翁的堡壘", use_container_width=True)
    expander.subheader("巨人格律翁")
    expander.write("巨人格律翁好戰且嫉妒，對任何侵入自己領土的人懷有強烈的敵意。巨人格律翁非常自信，覺得自己所擁有的東西無人能奪走。")
    expander.image("/home/tzuyang2024/桌面/DND 照片2/格律翁.jpeg", caption="巨人格律翁", use_container_width=True)
    ...
    expander.image("/home/tzuyang2024/桌面/DND 照片2/海岸線.jpeg", caption="海岸線", use_container_width=True)
    expander.subheader("卡利斯")
    expander.write("卡利斯是一位年輕且充滿魅力的海盜首領，精明、機智且不容小覷，具有非常強的領導能力。他善於交涉，並且在戰鬥中充滿動力。對他來說，報仇與金錢的誘惑是無法抗拒的。")
    expander.image("/home/tzuyang2024/桌面/DND 照片2/卡利斯.jpeg", caption="卡利斯", use_container_width=True)
    ...
    expander.image("/home/tzuyang2024/桌面/DND 照片2/葡萄園與橄欖樹林.jpeg", caption="葡萄園與橄欖樹林", use_container_width=True)
    expander.subheader("麥格諾")
    expander.write("麥格諾是一位年輕的獨臂獵人，沉默寡言、警覺，他信奉的是「智謀勝於力量」的信條，他經常保持冷靜，並且能在困境中提供關鍵的建議。他對牛群有著極深的了解。")
    expander.image("/home/tzuyang2024/桌面/DND 照片2/麥格諾.jpeg", caption="麥格諾", use_container_width=True)
    ...
    expander.image("/home/tzuyang2024/桌面/DND 照片2/亞娜.jpeg", caption="亞娜", use_container_width=True)
    ...
    expander.image("/home/tzuyang2024/桌面/DND 照片2/岩石峭壁.jpeg", caption="岩石峭壁", use_container_width=True)
    expander.subheader("無名英雄")
    expander.write("這五位無名英雄身形高大、肌肉結實，面容棱角分明，眼神堅毅，透露著無畏的勇氣。臉上有著戰鬥的疤痕與深深的皺紋，皮膚顯得粗糙而結實。")
    expander.image("/home/tzuyang2024/桌面/DND 照片2/無名英雄.jpeg", caption="無名英雄", use_container_width=True)

    expander = st.expander("牛群草原")
    expander.write("牛群所在的領地是一片寬廣的草原，巨人已經在這片區域布下了陷阱，並且他對自己的牛群充滿保護欲。每一頭牛都有強烈的領地意識，它們對異物的氣息極為敏感。")
    expander.image("/home/tzuyang2024/桌面/DND 照片2/牛群草原.jpeg", caption="牛群草原", use_container_width=True)
...
def content_tab13():
    ...
    expander.image("/home/tzuyang2024/桌面/DND 照片2/流浪商人帳篷.jpeg", caption="流浪商人的帳篷", use_container_width=True)
    expander.subheader("流浪商人卡呂普索")
    expander.write("一名神秘的流浪商人，他的臉部幾乎被深紫色的頭巾與斗篷遮掩，露出的僅是一雙如琥珀般的雙眼，總是閃爍著難以捉摸的光芒。他的膚色帶有一絲古銅色，手指纖長而靈巧，指節上帶著各式各樣的戒指，每一枚戒指的寶石似乎都蘊藏著不同的故事。他的身上總是披著一件深藍色的長袍，袖口繡著難以辨識的古老文字，偶爾隨步伐晃動，隱約可見暗金色的紋路浮現。")
    expander.image("/home/tzuyang2024/桌面/DND 照片2/卡呂普索.jpeg", caption="流浪商人卡呂普索", use_container_width=True)
    ...
    expander.image("/home/tzuyang2024/桌面/DND 照片2/聖園.jpeg", caption="聖園", use_container_width=True)
    ...
    expander.image("/home/tzuyang2024/桌面/DND 照片2/仙女與巨龍.jpeg", caption="仙女赫斯珀里得斯與巨龍拉頓", use_container_width=True)
